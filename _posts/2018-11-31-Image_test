---
title: IMage imbed test
subtitle: 
image: /img/journey.jpg
--- 

Just testing how to post images in github pages


{
  "config": {"view": {"width": 400, "height": 300}},
  "data": {"name": "data-581392c50203f76f1d8816d1534b59dc"},
  "mark": "point",
  "encoding": {
    "color": {
      "condition": {
    ...
    "tooltip": {"type": "nominal", "field": "Player"},
    "x": {"type": "quantitative", "field": "Salary"},
    "y": {"type": "quantitative", "field": "Points"}
  },
  "selection": {
    "Player ": {
      "type": "single",
      "fields": ["Position"],
      "bind": {"input": "select", "options": ["QB", "RB", "WR", "K"]},
      "on": "click",
      "resolve": "global",
      "empty": "all"
    }
  ...
  "datasets": {
    "data-581392c50203f76f1d8816d1534b59dc": [
      {
        "Player": "A.J. Derby",
        "Position": "TE",
        "Salary": 705000,
